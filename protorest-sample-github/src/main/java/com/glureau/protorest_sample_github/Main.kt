...
data class SimpleGithubRepository(val full_name: String?, val owner: GithubUser?, val private: Boolean?, val html_url: String?, val description: String?)
...
class GithubUserApi : RestApi("https://api.github.com/") {
    ...
    fun organization(orga: String) = rest("orgs/$orga", GithubOrganization::class.java)
    fun organizationSimple(orga: String) = rest("orgs/$orga", SimpleGithubOrganization::class.java)
    fun repository(login: String, repos: String) = rest("repos/$login/$repos", GithubRepository::class.java)
    fun repositorySimple(login: String, repos: String) = rest("repos/$login/$repos", SimpleGithubRepository::class.java)
}
