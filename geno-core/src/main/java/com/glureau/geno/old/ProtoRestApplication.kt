...
import com.glureau.geno.BuildConfig
import com.glureau.geno.old.rest.*
import com.squareup.leakcanary.LeakCanary
import timber.log.Timber
import kotlin.reflect.KClass

// TODO : Remove the toCustomize and use reflection/code generation to get classes by annotations
open class GenoApplication<out A : RestApi>(val api: A, val toCustomize: Array<KClass<*>> = emptyArray()) : Application() {
